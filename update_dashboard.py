...
<style>
  ...
  body.light-mode {{
    ...
    --text:#1a1d27; --muted:#64748b; --green:#059669; --red:#dc2626;
...
function render(){{
  ...
  sel('stats-row').innerHTML = `
    ...
    <div class="stat"><div class="stat-label">Avg Visits / Person<span class="info-btn" onclick="showInfo(event,'avg-visits')">?</span></div><div class="stat-value" style="color:#2dd4bf">${{avgVisits}}${{dHtml(avgDelta)}}</div><div class="stat-sub">vs prior period</div></div>
