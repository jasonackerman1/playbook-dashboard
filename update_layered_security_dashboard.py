...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0;}}
  ...
  /* ── Header ── */
  .header{{padding:20px 28px 16px;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;}}
...
<div class="header">
  ...
  <div style="display:flex;justify-content:flex-end;gap:8px;align-items:center;flex-wrap:wrap;">
    ...
    <button class="btn-theme print-hide" id="btn-import-cert" onclick="sel('cert-file-input').click()">&#128196; Import Sales Certification</button>
    <span class="info-btn print-hide" onclick="showInfo(event,'import-cert')">?</span>
...
function renderStats(){{
  ...
  var overdue = filtered.filter(isPastDue).length;
  ...
  sel("s-overdue").textContent    = overdue;
