...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0;}}
  ...
  .header{{padding:20px 32px;border-bottom:1px solid var(--border);background:var(--surface);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;}}
  ...
  .card{{background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:24px;display:flex;flex-direction:column;gap:16px;transition:border-color .15s;}}
  ...
  .stat-num{{font-size:32px;font-weight:700;line-height:1;font-variant-numeric:tabular-nums;}}
...
<div class="header">
  <div class="header-left">
    <h1>KM Learning Group</h1>
    <div class="header-sub">Dashboard Hub &middot; {today}</div>
  </div>
