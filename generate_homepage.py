...
# ── LinkedIn Learning Engagement stats ────────────────────────────────────────
def linkedin_learning_engagement_stats():
    try:
        from update_linkedin_learning_engagement_dashboard import load_linkedin_learning_engagement_data
        orig = os.getcwd()
        try:
            os.chdir(str(SCRIPT_DIR))
        ...
        print(f"    LinkedIn Learning Engagement stats error: {e}")
        return None
  ...
  <div class="grid">
    ...
    <div class="card" style="--card-bg:url('https://cdn.jsdelivr.net/gh/BradleyAPierce/Legal_Images_Copy/Sales_Education.jpg')">
      <div class="card-head">
        <span class="card-icon">&#128218;</span>
        <div>
          <div class="card-title">LinkedIn Learning Engagement</div>
      ...
      <div style="margin-top:auto;display:flex;align-items:flex-end;justify-content:space-between;gap:16px;">
        ...
        <a href="linkedin-learning-engagement.html" class="btn-open" style="flex-shrink:0;">Go to Dashboard &#8250;</a>
      </div>
    </div>
...
def main():
    ...
    print("  Reading LinkedIn Learning Engagement data...")
    le = linkedin_learning_engagement_stats()
    if le:
        print(f"    {le['learners']} learners, {le['reach']}% reach, {le['total_hours']} total hours")
    else:
        print("    No LinkedIn Learning Engagement data found")
