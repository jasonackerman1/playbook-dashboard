...
<div class="header">
  ...
  <div class="header-right">
    <button class="btn-theme" id="btn-beta-filter" onclick="toggleBetaFilter()">Hide Test Group</button>
...
<div class="wrap">
  ...
  <div class="data-note">
    ...
    <span>To appear on this board, a rep must close a deal within their first 45 days of the Accelerate program, complete the curriculum, and personally move that deal through both Sales Qualified and Engage. Deals handed off to a manager or teammate do not count. Once a rep&#8217;s 45-day window closes, they roll off the board.</span>
  </div>
  ...
  <div class="section">
    <div class="section-head">
      <div>
        ...
        <p>Reps currently inside their __WINDOW_DAYS__-day window who closed a deal within that window, completed the curriculum, and personally moved the deal through Sales Qualified and Engage. Reps roll off when their window closes. Each qualifying win is its own row.</p>
      </div>
...
function toggleBetaFilter(){
  ...
  btn.textContent = hideBeta ? 'Show Test Group' : 'Hide Test Group';
...
function renderAll(){
  ...
  leaderboardRows = DEALS.filter(d =>
    ...
    d.engageBy === d.name &&
    hireMap[d.name] && hireMap[d.name].eligible
  );
